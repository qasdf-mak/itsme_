<template>
	<view class="width-full lh1">
							...
							<view class="width-full height relative">
								...
								<view class="width-full height float-hidden">
									<view class="width-full height flex align-items-center flex-center"
										:class="((Number(item.rule_type) === 3 || (Number(item.rule_type) === 4 && Number(item.is_read) === 0 && !user.is_vip)) && !isMy) ? 'look-mask' : ''">
								...
								<view class="width-full" v-if="isLogin">
									<view class="width-full" v-if="!isMy">
										...
										<view
											...
											<image src="../../static/itsme/itsme_5.png" class="rule-huo"
												mode="widthFix"></image>
										...
										<view
											class="absolute top left right bottom flex align-items-center flex-center flex-col"
											v-if="item.type === 'itsme_image' && Number(item.rule_type) === 3 && Number(item.is_read) === 1">
											<image src="../../static/itsme/itsme_8.png" class="rule-huo"
												mode="widthFix"></image>
											...
											<view class="width-full"
												...
												<view
													class="mt15 huiyuan-btn bg-2 flex align-items-center flex-center btn-box"
													@click="toPayMember(item)" v-if="false">
													<image src="../../static/itsme/itsme_9.png" class="huiyuan-btn-img"
														mode="widthFix"></image>
										...
										<view
											...
											<image src="../../static/itsme/itsme_6.png" class="rule-huo"
											...
											<view
												class="media-btn-box btn-box bg-white mt12 flex align-items-center flex-center"
												@click="toPayMember(item)"
												v-if="user && user.is_vip === 0 && user.gender === 1">
												<image src="../../static/itsme/itsme_9.png" class="media-btn-img"
													mode="scaleToFill"></image>
												<view class="fs15 color-main6 ml10">
													升级会员
												</view>
											</view>
										</view>
		...
		<!-- 视频 -->
		<!-- M豆不足，提示充M豆 -->
		<custom-pop :showPop="moneyLess" confirmText="充值" cancelText="取消" contentTitle="M豆不足" :meiNv="3"
			@confirm="toRecharge" @cancel="moneyLess = false"></custom-pop>
		<!-- 发会员券 -->
